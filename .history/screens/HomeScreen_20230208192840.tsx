...
const Products: React.FC<prodmin> = (props)=>{
  ...
  const {item} = props
  return(
    <TouchableOpacity style={{ width:'100%',borderRadius:10}}>
      <BlurView
        intensity={90}
        tint='light'
        style={{
      ...
      >
        ...
        >
          <View>
            <Text style={{fontFamily:'Josephin',fontWeight:'600',fontSize:18,color:'#036ea8'}}>${' '}{item.price}</Text>
          </View>
        ...
        >
          ...
          <Text style={{fontFamily:'Abel',fontWeight:'700', color:'#3CB043'}}> In Stock </Text>
        </View> ):(
        <View
          style={{
            flexDirection:'row',
        ...
        >
          ...
          <Text style={{fontFamily:'Abel',textAlign:'center',fontWeight:'700',color:'#B90E0A'}}> Out Of Stock </Text>
        </View>)}
      </BlurView>
    </TouchableOpacity>
  )
