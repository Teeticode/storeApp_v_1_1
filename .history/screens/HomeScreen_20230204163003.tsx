...
const Products: React.FC<prodmin> = (props)=>{
  ...
  return(
    <View style={{margin:8}}>
      ...
      >
        <TouchableOpacity style={{height:150,width:'100%', marginBottom:'20%'}}>
        ...
        <Text>{item.name}</Text>
        {(item.countInStock >= 2) ?(<><Text style={{textAlign:'center', color:'#3CB043'}}><Ionicons name='information-circle-outline' size={20} color='#3CB043'/> Out Of Stock </Text></> ):(<><Text style={{textAlign:'center', color:'#B90E0A'}}><Ionicons name='information-circle-outline' size={20} color='#3CB043'/> In Stock </Text></>)}
      </BlurView>
    </View>
  )
}
