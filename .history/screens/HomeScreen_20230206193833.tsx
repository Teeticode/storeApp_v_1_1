    ...
    <View style={{ marginBottom:2,width:'100%',borderRadius:10}}>
      ...
      >
        ...
        >
          ...
          <Text style={{fontFamily:'Josephin',fontWeight:'600', color:'#3CB043'}}> In Stock </Text>
        </View> ):(<><Text style={{textAlign:'center',fontFamily:'Josephin',fontWeight:'700', color:'#B90E0A'}}><Ionicons name='information-circle-outline' size={20} color='#B90E0A'/> Out Of Stock </Text></>)}
      </BlurView>
    </View>
  )
}
                    ...
                    <FlatList
                      ...
                      renderItem={({item})=>(
                        <View 
                          ...
                          style={{
                            marginBottom:(products._id === item._id)?20:5
                          }}
                        >
                        <ScrollView
