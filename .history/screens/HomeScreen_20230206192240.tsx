  ...
  return(
    <View style={{ width:'100%',borderRadius:10}}>
      ...
      >
        ...
        {(item.countInStock > 2) ?(<><Ionicons style={{marginTop:14}} name='information-circle-outline' size={20} color='#3CB043'/><Text style={{textAlign:'center',fontFamily:'Josephin',fontWeight:'600', color:'#3CB043'}}> In Stock </Text></> ):(<><Text style={{textAlign:'center',fontFamily:'Josephin',fontWeight:'700', color:'#B90E0A'}}><Ionicons name='information-circle-outline' size={20} color='#B90E0A'/> Out Of Stock </Text></>)}
      </BlurView>
    </View>
  )
}
