    ...
    return (
        ...
        >
            ...
            <Animated.View style={[styles.button,styles.secondary]}>
               <Image source={deliveryadd} style={{width:35,height:35}}/>
            </Animated.View>
            
            </TouchableWithoutFeedback>
            <TouchableWithoutFeedback>
            <Animated.View style={[styles.button,styles.secondary]}>
            <Image source={favoriteadd} style={{width:35,height:35}}/>
            </Animated.View>
            
            </TouchableWithoutFeedback>
            <TouchableWithoutFeedback>
            <Animated.View style={[styles.button,styles.secondary]}>
            <Image source={storeadd} style={{width:35,height:35}}/>
            </Animated.View>
            
            </TouchableWithoutFeedback>
            <TouchableWithoutFeedback>
            <Animated.View style={[styles.button,styles.secondary]}>
            <Image source={phoneadd} style={{width:35,height:35}}/>
            </Animated.View>
