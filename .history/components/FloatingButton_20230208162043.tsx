    ...
    return (
        ...
        >
            ...
            <Animated.View style={[styles.button,styles.secondary]}>
               <Ionicons name='cart-outline' size={20} color='#036ea8'/>
            </Animated.View>
            
            </TouchableWithoutFeedback>
            <TouchableWithoutFeedback>
            <Animated.View style={[styles.button,styles.secondary]}>
               <Ionicons name='heart-outline' size={20} color='#036ea8'/>
            </Animated.View>
            
            </TouchableWithoutFeedback>
            <TouchableWithoutFeedback>
            <Animated.View style={[styles.button,styles.secondary]}>
               <Entypo name='location-pin' size={20} color='#036ea8'/>
            </Animated.View>
            ...
            <Animated.View style={[{
               ...
               <AntDesign style={{fontWeight:'700'}} name='plus' size={24} color='#fff'/>
            </Animated.View>
